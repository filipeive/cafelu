...
class LoginController extends AppBaseController
{
    ...
    */
    ...
    {
        $login = $request->input('username'); // o campo do form continua "username"

        // Verifica se o valor digitado é email ou username
        ...
        if (!$user->is_active) {
            throw ValidationException::withMessages([
                $field => ['Sua conta está desativada. Entre em contato com o administrador.'],
            ]);
        }
        ...
        if (Hash::check($request->input('password'), $user->password)) {
            ...
            $this->handleTemporaryPassword($user, $request->input('password'));
