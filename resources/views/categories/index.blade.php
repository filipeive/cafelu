                                        ...
                                        <td>
                                            @if ($category->is_active)
                                                <span class="badge bg-success">
                                                    <i class="mdi mdi-check-circle-outline me-1"></i> Ativo
                                                </span>
                                            @else
                                                <span class="badge bg-secondary">
                                                    <i class="mdi mdi-cancel me-1"></i> Desativado
                                                </span>
                                            @endif
                                        </td>
                                        <td>
                                            <div class="fw-medium">
                                                {{ \Carbon\Carbon::parse($category->created_at)->format('d/m/Y') }}</div>
                                            <small
                                                class="text-muted">{{ \Carbon\Carbon::parse($category->created_at)->format('H:i') }}</small>
                                        </td>
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="{{ route('categories.show', $category) }}"
                                                    class="action-btn btn btn-outline-primary" title="Ver detalhes">
                                                    <i class="mdi mdi-eye"></i>
                                                </a>
                                                <button type="button" class="action-btn btn btn-outline-warning"
                                                ...
                                                <button type="button" class="action-btn btn btn-outline-danger"
                                                    onclick="confirmDelete({{ $category->id }})" title="Excluir">
