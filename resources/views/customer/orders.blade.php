                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        @if($order->payment_status === 'awaiting_confirmation')
                                            <div class="px-3 py-2 rounded-lg bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 text-[10px] font-black uppercase flex items-center gap-1 border border-purple-100 dark:border-purple-800"
                                                title="Aguardando Confirmação">
                                                <i class="mdi mdi-clock-outline"></i> Aguardando
                                            </div>
                                        @elseif(!in_array($order->status, ['paid', 'completed', 'canceled']))
