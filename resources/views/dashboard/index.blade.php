...
<div class="dashboard-container">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="header-title animate-fade-in">Dashboard <strong style="color: var(--warning-color)"> Café Lufamina</strong></h1>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="table-status {{ $table->status === 'occupied' ? 'bg-danger' : 'bg-success' }} bg-opacity-10">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="mb-1 {{ $table->status === 'occupied' ? 'text-danger' : 'text-success' }}">
                                            Mesa {{ $table->number }}
                                        </h6>
                                        <small class="{{ $table->status === 'occupied' ? 'text-danger' : 'text-success' }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const salesData = @json($hourlySalesData);
    const hourlySalesLabels = salesData.map(item => item.hour);
    const hourlySalesData = salesData.map(item => item.value);
