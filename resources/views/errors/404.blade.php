...
<style>
  body{background:#071029;color:#e6eef8;font-family:Inter,system-ui,Arial;padding:40px}
  ...
  h1{font-size:56px;color:#62d2a2;margin:0 0 8px}
  ...
  .primary{background:#62d2a2;color:#042018}
...
<body>
  <div class="box">
    <h1>404</h1>
    <p><strong>Página não encontrada.</strong><br>O recurso que você procura não existe ou foi movido.</p>
    <div>
