...
@section('content')
    <div class="w-full" x-data="{ searchQuery: '' }">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Gestão de Despesas</h1>
                <p class="text-gray-500 dark:text-gray-400">Controle os gastos e saídas do seu negócio</p>
            </div>
            <div class="flex gap-3">
                <a href="{{ route('expenses.create') }}"
                    ...
                    <i class="mdi mdi-plus mr-2"></i> Nova Despesa
                </a>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
            <div class="relative">
                ...
                <input type="text" x-model="searchQuery" placeholder="Pesquisar por descrição ou categoria..."
                        ...
                        @forelse($expenses as $expense)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="text-xs text-gray-500 dark:text-gray-400">Por:
