                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <p>
                            ...
                            <strong>Capacidade Total:</strong> {{ $order->table->merged_capacity ?? $order->table->capacity }} lugares<br>
            ...
            <form action="{{ route('orders.pay', $order) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        <strong>Total a Pagar:</strong> {{ number_format($order->total_amount, 2, ',', '.') }} MZN
                    </div>
                </div>
