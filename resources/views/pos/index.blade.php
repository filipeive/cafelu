        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="category-filters">
                    <button class="category-btn {{ empty($categoryFilter) ? 'active' : '' }}" data-category="all">
                        <i class="mdi mdi-view-grid"></i>Todos
                    </button>
                    @foreach ($categories as $category)
                        <button class="category-btn {{ $categoryFilter == $category['id'] ? 'active' : '' }}" data-category="{{ $category['id'] }}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Debug de carregamento de produtos e categorias
        ...
        // Adicionar esta função no final do arquivo Blade, dentro do script
