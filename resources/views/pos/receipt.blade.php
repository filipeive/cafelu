    ...
    <div class="receipt">
                ...
                <tbody>
                    @foreach($items as $item)
                        <tr>
                            ...
                            <td style="text-align: right;">MZN {{ number_format($item->unit_price * $item->quantity, 2) }}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
        ...
        <div class="payment-methods">
            ...
            @if($sale->cash_amount > 0 && $sale->cash_amount > $sale->total_amount)
                <div class="item">Troco: <span>MZN {{ number_format($sale->cash_amount - $sale->total_amount, 2) }}</span>
                </div>
            @endif
        </div>
        ...
        <div class="no-print">
            <button class="btn-print" onclick="closeAndReturn()">Fechar e Voltar</button>
        </div>
