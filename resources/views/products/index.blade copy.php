                ...
                <form id="productForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="form-text text-muted">Formatos aceitos: jpg, png, jpeg. Tamanho máximo: 2MB.</small>
                        
                            <div id="existingImageContainer" class="mt-2 d-none">
                                <img id="existingImage" src="" alt="Imagem do Produto" class="img-thumbnail mb-2" style="max-width: 150px;">
                                <button type="button" class="btn btn-sm btn-danger" onclick="removeImage()">Eliminar Imagem</button>
                            </div>
                        </div>                        
                        <div class="form-group mb-3">
    ...
    <script>
        window.editProduct = function(productId) {
            ...
            $.get("{{ route('products.index') }}/" + productId, function(data) {
                ...
                if (data.image_url) {
                    $('#existingImage').attr('src', data.image_url);
                    $('#existingImageContainer').removeClass('d-none');
                } else {
                    $('#existingImageContainer').addClass('d-none');
                }
        ...
        function removeImage() {
            ...
            $('#productForm').append('<input type="hidden" name="remove_image" value="1">');
        }
