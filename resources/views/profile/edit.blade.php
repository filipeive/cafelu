                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}" id="passwordForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label for="password_confirmation" class="form-label fw-semibold">Confirmar Nova Senha
                                    *</label>
                                <div class="input-group">
                                    <input type="password"
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('profile.update-photo') }}" enctype="multipart/form-data"
                        ...
                        <div class="text-center mb-4">
                            <img id="photo-preview" src="{{ $user->avatar_url }}" class="rounded-circle mb-3"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('profile.destroy') }}" id="deleteAccountForm">
                        ...
                        <div class="mb-3">
                            <label for="password_delete" class="form-label fw-semibold">Confirme sua senha para
                                continuar:</label>
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
