...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('messages.new_sale') }}</h4>
                            ...
                            <div class="col-md-8">
                                <div class="product-selection mb-4">
                                    ...
                                    <button type="button" class="btn btn-success" id="add-product">
                                        <i class="mdi mdi-plus"></i> {{ __('messages.add_product') }}
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment-method" required>
                                                ...
                                                <option value="mpesa">{{ __('messages.mpesa') }}</option>
                                                <option value="emola">{{ __('messages.emola') }}</option>
                                                <option value="mixed">{{ __('messages.mixed_payment') }}</option>
                                            </select>
                                        </div>

                                        <div id="mixed-payment" style="display: none;">
                                            <div class="form-group">
                                                <label>{{ __('messages.cash_amount') }}</label>
                                                <input type="number" class="form-control" name="cash_amount" value="0"
                                                    min="0" step="0.01">
                                            </div>
                                            <div class="form-group">
                                                <label>{{ __('messages.card_amount') }}</label>
                                                <input type="number" class="form-control" name="card_amount" value="0"
                                                    min="0" step="0.01">
                                            </div>
                                            <div class="form-group">
                                                <label>{{ __('messages.mpesa_amount') }}</label>
                                                <input type="number" class="form-control" name="mpesa_amount" value="0"
                                                    min="0" step="0.01">
                                            </div>
                                            <div class="form-group">
                                                <label>{{ __('messages.emola_amount') }}</label>
                                                <input type="number" class="form-control" name="emola_amount" value="0"
                                                    min="0" step="0.01">
                                            </div>
                                        </div>

                                        <div class="mt-4">
                                            <h4>{{ __('messages.total') }}: <span id="total-amount">0.00</span></h4>
                                        </div>

                                        <button type="submit" class="btn btn-primary btn-block mt-4">
                                            {{ __('messages.finish_sale') }}
                                        </button>
                                    </div>
                                </div>
                            </div>
