                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu p-3" aria-labelledby="dateFilterDropdown"
                                    ...
                                    <li class="mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateFilter" id="yesterday"
                                                value="yesterday">
                                    ...
                                    <li class="mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateFilter" id="lastWeek"
                                                value="lastWeek">
                                    ...
                                    <li class="mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="dateFilter" id="lastMonth"
                                                value="lastMonth">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                    <li><a class="dropdown-item" href="#" id="exportExcel"><i
                                                class="mdi mdi-file-excel me-2 text-success"></i>Excel</a></li>
                                    <li><a class="dropdown-item" href="#" id="exportPDF"><i
                                                class="mdi mdi-file-pdf me-2 text-danger"></i>PDF</a></li>
                                    <li><a class="dropdown-item" href="#" id="exportCSV"><i
                                                class="mdi mdi-file-delimited me-2 text-primary"></i>CSV</a></li>
                                </ul>
                            </div>
                            ...
                            <tbody>
                                @foreach ($sales as $sale)
                                    <tr>
                                        ...
                                        <td class="py-3">
                                            <div
                                                class="badge {{ get_status_class_staradmins($sale->status) }} rounded-pill px-3">
                                        ...
                                        <td class="py-3">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <form action="{{ route('sales.print', $sale->id) }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control payment-input" id="cashPayment"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">MZN</span>
                                                <input type="number" class="form-control payment-input" id="cardPayment"
                                                    value="0" min="0" step="0.01">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control payment-input"
                                                    id="mpesaPayment" value="0" min="0" step="0.01">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">MZN</span>
                                                <input type="number" class="form-control payment-input"
                                                    id="emolaPayment" value="0" min="0" step="0.01">
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function addItemToSale(productId, productName, productPrice) {
                ...
                if (existingItemIndex !== -1) {
                    ...
                    saleItems[existingItemIndex].total = saleItems[existingItemIndex].quantity * saleItems[existingItemIndex]
                        .price;
                } else {
