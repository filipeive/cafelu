    ...
    <div class="row">
        <div class="col-12">
                    ...
                    <form method="GET" action="{{ route('search.index') }}" class="row g-3">
                        ...
                        <div class="col-md-3">
                            <select name="type" class="form-select form-select-lg">
                                <option value="all" {{ ($type ?? 'all') === 'all' ? 'selected' : '' }}>Todos os tipos
                                </option>
                                <option value="products" {{ ($type ?? '') === 'products' ? 'selected' : '' }}>Produtos
                                </option>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="row text-start">
                                    ...
                                    <div class="col-md-6">
                                        <ul class="list-unstyled">
                                            @if (Any(['view_orders', 'create_orders']))
                                                <li class="mb-2">
            ...
            @else
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    @if (isset($item['price']) && is_numeric($item['price']))
                                                        <small class="fw-bold text-primary">
                                                            {{ number_format((float) $item['price'], 2, ',', '.') }} MZN
                                                        </small>
                                                    @else
                                                        <small class="text-muted">Preço indisponível</small>
                                                    @endif
                                                    ...
                                                    @if (isset($item['stock']))
                                                        <small class="text-muted">
                                                            Estoque: <span
                                                                class="fw-bold {{ $item['stock'] > 0 ? 'text-success' : 'text-danger' }}">
                                                                {{ $item['stock'] }}
                                                            </span>
                                                        </small>
                                                    @endif
                ...
                @if ($results->has('products') && 'create_sales')
