...
@section('title-icon', 'mdi-users-gear')
    ...
    <div class="card-body p-0">
        ...
        @else
            <div class="text-center py-5">
                <i class="mdi mdi-users mdi-4x text-muted mb-3"></i>
                ...
                <a href="{{ route('users.create') }}" class="btn btn-primary">
                    <i class="mdi mdi-plus me-1"></i> Criar Primeiro Usuário
                </a>
            </div>
        @endif
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.toggle-status').forEach(button => {
        button.addEventListener('click', function() {
            ...
            this.innerHTML = '<i class="mdi mdi-spinner mdi-spin me-1"></i> Processando...';
            this.disabled = true;
    ...
    document.querySelectorAll('.reset-password').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const originalText = this.innerHTML;
            this.innerHTML = '<i class="mdi mdi-spinner mdi-spin me-1"></i> Gerando...';
            this.disabled = true;
    ...
    document.querySelectorAll('.invalidate-temp').forEach(button => {
        button.addEventListener('click', function() {
            ...
            const originalText = this.innerHTML;
            this.innerHTML = '<i class="mdi mdi-spinner mdi-spin me-1"></i> Invalidando...';
            this.disabled = true;
                ...
                <div class="modal-content">
                    <div class="modal-header bg-warning text-white">
                        <h5 class="modal-title">
                            <i class="mdi mdi-key me-2"></i>Senha Temporária - ${userName}
                        </h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-warning" onclick="copyPassword('${password}')">
                            <i class="mdi mdi-copy me-2"></i>Copiar
                        </button>
                    </div>
                </div>
            </div>
