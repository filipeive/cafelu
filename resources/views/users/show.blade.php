        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('users.index') }}" class="text-sm text-gray-500 hover:text-orange-500 dark:text-gray-400 transition-colors">
                                <i class="mdi mdi-account-group mr-1"></i> {{ __('messages.users') }}
                            </a>
                        </li>
                        <li>
                            <div class="flex items-center">
                                <i class="mdi mdi-chevron-right text-gray-400"></i>
                                <span class="ml-1 text-sm font-medium text-gray-900 dark:text-white md:ml-2">{{ __('messages.details') }}</span>
                            </div>
                        </li>
                    </ol>
                </nav>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('messages.user_profile') }}</h1>
            </div>
            <div class="flex gap-3">
                ...
                <a href="{{ route('users.edit', $user->id) }}" 
                    ...
                    <i class="mdi mdi-pencil mr-2"></i> {{ __('messages.edit') }}
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="px-6 pb-8">
                        ...
                        <div class="mt-8 space-y-4 border-t border-gray-100 dark:border-gray-700 pt-6">
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">{{ __('messages.username') }}</span>
                                <span class="font-bold text-gray-900 dark:text-white">{{ $user->username }}</span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">{{ __('messages.status') }}</span>
                            ...
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">{{ __('messages.last_access') }}</span>
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <h3 class="text-sm font-bold text-gray-900 dark:text-white mb-4 uppercase tracking-wider">{{ __('messages.system_info') }}</h3>
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('messages.created_at') }}</p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('messages.updated_at') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                        ...
                        <span class="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-xs font-bold rounded-full">
                            {{ $user->auditLogs()->count() }} {{ __('messages.records') }}
                        </span>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        @if($logs->count() > 0)
                            ...
                            <div class="mt-6 text-center">
                                <a href="#" class="text-sm font-bold text-orange-500 hover:text-orange-600 transition-colors">{{ __('messages.view_all_history') }}</a>
                            </div>
                        @else
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">{{ __('messages.no_activity_found') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
