    ...
    <style>
        ...
        * {
        ...
        .header {
            ...
            overflow: hidden;
            /* Remova a opacidade da header se estava em 0.95 */
        }
        ...
        .header::before {
            ...
            z-index: 0;
            /* Fica entre a imagem e o conteúdo */
        }

        .header>* {
            position: relative;
            z-index: 1;
            /* Garante que o conteúdo fique acima da camada preta */
        }
        ...
        .logo {
            ...
            overflow: hidden;
            /* garante que a imagem siga o círculo */
        }
